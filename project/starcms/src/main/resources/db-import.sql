INSERT INTO `bg_role` (id, name, priority, state) VALUES (1, '管理员', 1, 1);
INSERT INTO `bg_role` (id, name, priority, state) VALUES (2, '录入人员', 2, 1);
INSERT INTO `bg_role` (id, name, priority, state) VALUES (3, '审核人员', 3, 1);
COMMIT;
INSERT INTO `bg_user` (id, name, password, real_name, regist_time, regist_ip, login_count, data_range, state)
 VALUES (1, 'admin', '$2a$10$sv.ZgyVW3AANy.JB6GyQ/u0ibtaPDm7mGvSyu.V7GMjI/LqyrPMQW', 'administrator', '2022-7-26', '127.0.0.1', 0, 1, 1);
COMMIT;
